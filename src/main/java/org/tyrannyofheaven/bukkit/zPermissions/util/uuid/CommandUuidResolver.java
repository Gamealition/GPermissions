...
public class CommandUuidResolver {
    ...
    public void resolveUsername(CommandSender sender, String name, boolean skip, boolean forceInline, CommandUuidResolverHandler handler) {
        ...
        if (skip || name == null) {
            ...
            UuidDisplayName udn = UuidUtils.parseUuidDisplayName(name);
            if (udn != null) {
                String displayName;
                ...
                if (player != null) {
                    ...
                    if (udn != null) {
                        ...
                        ToHMessageUtils.sendMessage(sender, ToHMessageUtils.colorize("{GRAY}(Resolving UUID...)"));
    ...
    private void fail(CommandSender sender, String name) {
        ToHMessageUtils.sendMessage(sender, ToHMessageUtils.colorize("{RED}Failed to lookup UUID for {AQUA}%s"), name);
